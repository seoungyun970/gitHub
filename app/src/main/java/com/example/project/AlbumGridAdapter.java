...
public class AlbumGridAdapter extends BaseAdapter {
    ...
    public AlbumGridAdapter(Context context, int[] imageIDs) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null != convertView)
            ...
            AlbumGridClickListener mAlbumGridClickListener
                    = new AlbumGridClickListener(context, imageIDs[position]);
            imageView.setOnClickListener(mAlbumGridClickListener);
        }
        return imageView;
    }
